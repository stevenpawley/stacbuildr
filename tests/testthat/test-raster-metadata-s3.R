test_that("raster statistics use S3 fields", {
  ...
  expect_true(inherits(stats, "raster_statistics"))
...
test_that("raster histograms use validated S3 fields", {
  ...
  expect_true(inherits(histogram, "raster_histogram"))
