...
stopifnot(all(names(py_catalog) %in% names(catalog_rjson)))

# Same number of links
stopifnot(length(py_catalog$links) == length(catalog_rjson$links))

# root link hrefs match
stopifnot(get_link(catalog_rjson$links, "root")$href == get_link(py_catalog$links, "root")$href)

# item link hrefs match
stopifnot(get_link(catalog_rjson$links, "item")$href == get_link(py_catalog$links, "item")$href)

# self link: stacbuildr uses relative, pystac uses absolute (known difference)
stopifnot(get_link(catalog_rjson$links, "self")$href == "./catalog.json")
